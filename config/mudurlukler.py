# -*- coding: utf-8 -*-
"""T.C. Dörtyol Belediyesi müdürlük bilgileri - kaynak: https://www.dortyol.bel.tr"""
...
MUDURLUK_BILGILERI = {
    "Fen İşleri Müdürlüğü": {
        ...
        "telefon_dahili": "1043",
        "aciklama": (
            "Dörtyol Belediyesi sınırları içerisinde yürürlükteki İmar Planlarına uygun olarak "
            "sorumluluk alanı dâhilinde yeni yolların yapılması, mevcut yolların onarılması, "
            "Belediye'nin diğer birimleri ile işbirliği içerisinde kaçak yapıların yıkılması için "
            "gerekli araç-gereç ve ekipmanı sağlamak, hafriyat işlerinin yürütülmesini takip etmek, "
            "vatandaşların istek ve şikâyetlerini alıp değerlendirmek ve sonucunu ilgili kişi ve "
            "kurumlara iletmek, fiziki çevre düzenlemeleri (bordur, yaya yolu vb.) ile ilgili işleri "
            "yürütmek, ilçenin altyapı ve yatırımlarının amaca ve onaylanan planlara uygun olarak "
            "yapılmasını koordine etmek, bölgedeki molozların toplanması ve döküm yerlerine "
            "nakledilmesi, sunulan hizmetlerle ilgili ve belediyenin diğer birimlerin ihale yoluyla "
            "yapılacak işlerin proje ve ihale işlemlerini, hak edişleri ve ödemelerini takip etmekten "
            "kontrollük görevini yürütmek, hizmetlerde kullanılan Dörtyol Belediyesine ait tüm araç "
            "ve iş makinelerinin onarım tamir ve bakımlarını yapmak veya yaptırmaktır."
        ),
        "gorevler": [
    ...
    "İmar ve Şehircilik Müdürlüğü": {
        ...
        "telefon_dahili": "1031",
        "aciklama": (
            "Dörtyol Belediye Başkanlığı İmar ve Şehircilik Müdürlüğü; ilçe sınırları içerisinde "
            "imar ve planlama çalışmalarının aksamadan yürütülmesini sağlamak, imar planlarının "
            "yapılması, hazırlanması, revizyonu ve tadilatlarının yapılması, imar uygulama ile "
            "ilgili imar durumu, istikamet rölevesi, kot-kesit tanzimi, mimari, statik, ısı yalıtım, "
            "elektrik ve mekanik projelerinin onaylanması, inşaat ruhsatlarının düzenlenmesi, "
            "iskan işlemleri, yapı denetim ve kontrol hizmetleri ile ruhsata aykırı yapılar "
            "hakkında yasal işlemlerin takibinden sorumludur."
        ),
        "gorevler": [
    ...
    "Park ve Bahçeler Müdürlüğü": {
        ...
        "telefon_dahili": "2101",
        "aciklama": (
            "Sorumluluk alanı içerisinde bulunan mevcut park ve yeşil alanların; bakım, onarım ve "
            "iyileştirme çalışmaları yaparak Avrupa standartları seviyesine getirmek. Dörtyol ilçesi "
            "genelinde yeni yeşil alanların ve parkların kazandırılmasını sağlamak. İlçe geneli "
            "sorumluluk sahasında bulunan parkların, yeşil alanların, yolların, kaldırımların ve "
            "kamu kurum ve kuruluşlarının çevre düzenlemesi, ağaç budaması ve kesimi, çim biçimi "
            "gibi görevleri yerine getirmektir."
        ),
        "gorevler": [
    ...
    "Zabıta Müdürlüğü": {
        ...
        "telefon_dahili": "3001",
        "aciklama": (
            "Zabıta, görevlendirildikleri bölgede kamu düzenini sağlamak, huzuru tesis etmek ve "
            "halk sağlığını korumak ile görevlidir. Zabıtaların bazıları sabit bazıları ise gezici "
            "olarak denetim yapar. Gıda malzemeleri üreten, satan ya da dağıtan işyerlerinin "
            "denetimleri, ruhsatsız iş yerlerinin tespiti, semt pazarı düzeni, seyyar satıcı "
            "kontrolü ve izinsiz ilan-afiş denetimleri müdürlüğün temel görevleri arasındadır."
        ),
        "gorevler": [
    ...
    "Temizlik İşleri Müdürlüğü": {
        ...
        "telefon_dahili": "2011",
        "aciklama": (
            "Dörtyol Belediyesi sınırları içerisinde sağlıklı bir yaşam ve temiz bir çevre "
            "oluşturabilmesi için belediye sınırları içinde temizlik çalışmalarının aksamadan "
            "yürütülmesi, çöplerin toplanması ve çöp toplama alanlarına nakledilmesi, cadde ve "
            "sokakların süpürülmesi ve yıkanması, pazaryerlerinin yıkanması ve dezenfeksiyonu "
            "işlemlerinin kontrol ve takibinden sorumludur."
        ),
        "gorevler": [
    ...
    "Bilgi İşlem Müdürlüğü": {
        ...
        "telefon_dahili": "1453",
        "aciklama": (
            "Bilgi İşlem Müdürlüğü; Belediyenin orta ve uzun vadeli bilgi işlem politikalarını "
            "belirlemek, bilişim sistemlerini kurmak, işletmek, bakım ve onarımlarını yapmak, "
            "bilişim hizmetlerini ilgili birimlerle birlikte yürütmek, bilgi işlem standartlarının "
            "belirlenmesi ve gelişiminin izlenmesi, gelişen bilişim teknolojisinin belediye "
            "bünyesine aktarımı konularında çalışmalar yürütmektedir."
        ),
        "gorevler": [
    ...
    "Basın Yayın ve Halkla İlişkiler Müdürlüğü": {
        ...
        "telefon_dahili": "1111",
        "aciklama": (
            "Katılımcı ve şeffaf bir yönetim anlayışı ile adalet ve dürüstlükten ödün vermeme "
            "kararlılığı içerisinde, kaynakları planlı, programlı, etkili ve verimli kullanarak, "
    ...
    "Afet İşleri ve Risk Yönetimi Müdürlüğü": {
        ...
        "telefon_dahili": None,
        "aciklama": (
            "Bu yönetmelik; Dörtyol ilçesindeki afet ile ilgili hizmetlerin etkin bir şekilde "
            "gerçekleştirilmesi amacıyla afet öncesinde hazırlık ve risk yönetimi, afet sırasında "
            "müdahale ve kriz yönetimi, afet sonrasında iyileştirme faaliyetleri için gerekli "
            "önlemlerin alınması, afetlere dirençli yerleşim yerlerinin oluşturulması ve afetlerin "
            "zararlarının azaltılmasına yönelik çalışmaların yapılması ile birimler arası "
            "koordinasyonun sağlanması ve afetlere yönelik politikaların üretilmesi ile "
    ...
    "Emlak ve İstimlak Müdürlüğü": {
        ...
        "telefon_dahili": "1080",
        "aciklama": (
            "Emlak ve İstimlak Müdürlüğü; belediyeye ait taşınmaz malların kayıtlarını düzenli "
            "bir şekilde tutmak, takip ve kontrolünü sağlamak, taşınmazları fuzuli işgalden "
            "korumak, kamulaştırma işlemlerini yürütmek, arsa tahsis ve kentsel dönüşüm "
            "faaliyetlerini gerçekleştirmek, belediye mülklerinin satış, kira, trampa ve "
            "değerlendirme işlemlerini yürütmekten sorumludur."
        ),
        "gorevler": [
    ...
    "Su ve Kanalizasyon İşleri": {
        ...
        "telefon_dahili": "1043",
        "aciklama": (
            "Su ve kanalizasyon altyapı hizmetleri Fen İşleri Müdürlüğü kapsamında yürütülmektedir. "
            "Fen İşleri Müdürlüğü; ilçenin alt yapı ve yatırımlarının amaca ve onaylanan planlara "
            "uygun olarak yapılmasını koordine etmek, kent donatılarının kurulması, alt yapı "
            "hizmetlerinin tesisi ve denetlenmesi, yol, meydan, bulvar ve yaya yollarının çağın "
            "gereklerine ve standartlarına uygun yapılması görevleri arasında su ve kanalizasyon "
            "altyapı çalışmaları da yer almaktadır."
        ),
        "gorevler": [
    ...
    "Kültür Sanat ve Sosyal İşler Müdürlüğü": {
        ...
        "telefon_dahili": "2090",
        "aciklama": (
            "Belediyemiz Kültür ve Sosyal İşler Müdürlüğü bünyesinde Kuzuculu, Altınçağ, Ocaklı, "
            "Çaylı, Yeşilköy, Yeniyurt, Kışlalar, Karakese ve Özerli mahallelerinde faaliyet gösteren "
            "AÇEM (Anne Çocuk Eğitim Merkezi) merkezlerinde bayanlara kurs ve okul öncesi "
            "çocuklara oyun odası eğitimi verilmektedir. Karahasan Paşa Sosyal Tesisinde düğün ve "
            "nikah hizmeti sunulmakta; Özerli mahallesindeki İlk Kurşun Müzesi ve Atatürk Evi "
            "hafta içi ve hafta sonu 08:00-17:00 saatleri arasında ziyarete açıktır."
        ),
        "gorevler": [
    ...
    "Destek Hizmetleri Müdürlüğü": {
        ...
        "telefon_dahili": "2000",
        "aciklama": (
            "Destek Hizmetleri Müdürlüğü; karar alma, uygulama ve eylemlerde şeffaflık, "
            "hizmetlerin temin ve sunumunda yerindelik ve ihtiyaca uygunluk, hesap verebilirlik, "
            "katılımcılık, adil ve eşit hizmet, kaynakların etkin ve verimli kullanımı ile "
            "sürdürülebilirlik ilkelerini esas alır. Belediyeye ait bina ve tesislerin "
            "ısıtma-soğutma, bakım-onarım hizmetleri, kırtasiye ve malzeme tedariki, taşınır "
            "kayıt işlemleri ve hizmet araçlarının yönetiminden sorumludur."
        ),
        "gorevler": [
    ...
    "Ruhsat ve Denetim Müdürlüğü": {
        ...
        "telefon_dahili": "1085",
        "aciklama": (
            "Ruhsat ve Denetim Müdürlüğü; ilgili kanunlar ve yönetmelikler doğrultusunda "
            "Belediye tarafından ruhsatlandırılması gereken iş yerlerinin İş Yeri Açma ve "
            "Çalıştırma Ruhsatı işlemlerini düzenli ve koordineli bir şekilde yürütmek ve "
            "denetlemesinden sorumludur."
        ),
        "gorevler": [
